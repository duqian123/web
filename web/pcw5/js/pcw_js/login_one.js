...
/*返回*/
$(".ui-header .fh").on("tap", function () {
    if (history.length == 0) {
        location.href = login_one + '.html';
    } else if (history.length == 1) {
        history.go(-1);
    } else if (history.length > 1) {
        var ym_id = parseInt($.getUrlParam("ym_id")),
            old_ym_id = parseInt($.getUrlParam("old_ym_id")),
            new_ym_id = parseInt($.getUrlParam("new_ym_id")),
            pt_id = parseInt($.getUrlParam("pt_id"));
        ...
        switch (ym_id) {
            ...
            case 1:
                ...
                break;
            case 4:
                location.href = details+".html?pt_id="+pt_id+"&ym_id="+old_ym_id;
                break;
            /*case 2:
             console.log(2);
